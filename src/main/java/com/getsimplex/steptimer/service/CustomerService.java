...
public class CustomerService {
    ...
    public static Optional<Customer> findCustomerByPhone(String customerPhone) throws Exception{
        Optional<Customer> matchingCustomer = JedisData.getEntityById(Customer.class, customerPhone);
